...
public class AssetTests extends AbstractHeadlessGdxTest {
    // have to use direct file addresses as original group input data into methods
    // and classes directly instead of using variables
    @Test
    ...
    public void particlesAssetTest() {
        ...
        assertTrue(Gdx.files.internal("particles/effects/fire.p").exists(),
                "Money particles missing");
        assertTrue(Gdx.files.internal("particles/effects/thunder.p").exists(),
                "Money particles missing");
        ...
        assertTrue(Gdx.files.internal("particles/images/fire.png").exists(),
                "Money texture missing");
        assertTrue(Gdx.files.internal("particles/images/thunder.png").exists(),
                "Money texture missing");
    }
